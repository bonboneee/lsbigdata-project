...
#test데이터 불러오기
house_test = pd.read_csv("data/house price/test.csv")
...
#비어있는 테스트 세트 집들 확인 
house_test.loc[house_test["SalePrice"].isna().sum()]
...
sub_df.to_csv("./data/housepricesample_submission2.csv", index = False)
